...
public class MetricsgenConfig {
    ...
    private static final String DEFAULT_OTELCOL_CONFIG = "jingra-config/otelcol.yaml";
    ...
    @JsonProperty("otelcol_config")
    private String otelColConfig;
    ...
    public String getOtelColConfig() { return otelColConfig; }
    ...
    public void setOtelColConfig(String otelColConfig){ this.otelColConfig = otelColConfig; }
    ...
    public String otelColConfigOrDefault() { return otelColConfig != null ? otelColConfig : DEFAULT_OTELCOL_CONFIG;}
}
